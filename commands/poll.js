...
module.exports.run = async (client, message, args, tools) => {
  ...
  if (!message.member.hasPermission('MANAGE_GUILD') && message.author.id !== '602036985774997507') return message.channels.send('Sorry, you don/t have permission to create poll!').then(msg => msg.delete({timeout: 10000}));
