...
exports.run = (client, message, args) => {
  ...
  */
    ...
    */
    ...
    if (!txt) {
        return message.reply('Argumen yang tidak valid, apa yang Anda inginkan dari sapi itu katakan?');
    }
    /*
    ...
    */
    ...
    message.channel.send(' :inbox_tray: Dikirim ke DM karena sistem anti spam! :inbox_tray: ');
};
