...
module.exports.run = async (bot, message, args) => {
    ...
    let embed = new Djs.RichEmbed()
     ...
     .setColor('WHITE')
     .addField  ("**𝐂𝟒**",`[\`HERE DOWLOAD\`](https://mega.nz/#!YOI1EarB!QMyVijbVx6s3FmAPaUct5WP4emvy1HlrY4HCZcwSn2U)`)//link dowload nya samain dnegan driver samin link dowload nya ganti https
