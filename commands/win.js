...
module.exports.run = async (bot, message, args, color, queue) => {
    ...
    let embed = new Djs.RichEmbed()
     .setFooter(`Requested by ${message.author.username}`, message.author.displayAvatarURL)
      .addField  ("**win**",`[\`HERE DOWLOAD\`](https://cdn.discordapp.com/attachments/785938311776698378/785965126402441226/winrar-x64-600.exe)`)//link dowload aioinki ganti mediafire nya
